...
docker compose --env-file .env -f core/compose.yml up -d --build --pull always
...
set -euo pipefail
cd /DATA/stacks/stacks
docker compose --env-file .env -f security/compose.yml up -d --build --pull always
sleep 5
...
do_media() {
    ...
    ssh_cmd "cd /DATA/stacks/stacks && docker compose --env-file .env -f media/compose.yml up -d --build --pull always"
    ok "Media stack running"
}

do_productivity() {
    log "Starting productivity stack..."
    ssh_cmd "cd /DATA/stacks/stacks && docker compose --env-file .env -f productivity/compose.yml up -d --build --pull always"
    ok "Productivity stack running"
}

do_ci() {
    log "Starting CI stack..."
    ssh_cmd "cd /DATA/stacks/stacks && docker compose --env-file .env -f ci/compose.yml up -d --build --pull always"
    ok "CI stack running"
}

do_monitoring() {
    log "Starting monitoring stack..."
    ssh_cmd "cd /DATA/stacks/stacks && docker compose --env-file .env -f monitoring/compose.yml up -d --build --pull always"
    ok "Monitoring stack running"
}

do_notifications() {
    log "Starting notifications stack..."
    ssh_cmd "cd /DATA/stacks/stacks && docker compose --env-file .env -f notifications/compose.yml up -d --build --pull always"
    ok "Notifications stack running"
}

do_utilities() {
    log "Starting utilities stack..."
    ssh_cmd "cd /DATA/stacks/stacks && docker compose --env-file .env -f utilities/compose.yml up -d --build --pull always"
    ok "Utilities stack running"
}

do_dashboard() {
    log "Starting dashboard stack..."
    ssh_cmd "cd /DATA/stacks/stacks && docker compose --env-file .env -f dashboard/compose.yml up -d --build --pull always"
